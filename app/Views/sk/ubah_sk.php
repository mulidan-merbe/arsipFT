      ...
      <div class="row mt-2">
        ...
        <div class="card card-primary card-outline" style="min-height: 650px;">
              <div class="card-header">
                ...
                <h3 class="card-title">Ubah Data Surat Keputusan
            ...
            <button  type="button" class="btn btn-sm btn-warning float-right" onclick="javascript:history.back()"><i class="fa fa-chevron-left" aria-hidden="true"></i></button>
              ...
              <form method="post" action="<?= base_url('sk/ubahData/'. $value['Id_sk']) ?>" enctype="multipart/form-data">
              <?= csrf_field(); ?>
              <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input type="text" name="Nomor_sk" class="form-control <?= ($validation->hasError('Nomor_sk')) ? 'is-invalid' : ''; ?>"  value="<?= $value['Nomor_sk'] ?>">
               ...
               <div class="form-group row">
                ...
                <div class="col-md-4">
                <input type="date" name="Tanggal_sk" class="form-control <?= ($validation->hasError('Tanggal_sk')) ? 'is-invalid' : ''; ?>"  value="<?= $value['Tanggal_sk'] ?>">
               ...
               <div class="form-group row">
                ...
                <div class="col-md-11">
                <textarea name="Tentang" id="" cols="30" rows="10" class="form-control <?= ($validation->hasError('Tentang')) ? 'is-invalid' : ''; ?>"  value="<?= $value['Tentang'] ?>"><?= $value['Tentang'] ?></textarea>
               ...
               <div class="form-group row">
                ...
                <div class="custom-file">
                        <input type="file" name="Berkas" class="custom-file-input <?= ($validation->hasError('Berkas')) ? 'is-invalid' : ''; ?>"  value="<?= $value['Berkas'] ?>" id="berkas" onchange="previewLabel()">
